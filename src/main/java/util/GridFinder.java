 ...
 *
 * <p>Grid positions are treated as world-space origins. Coordinates in {@code Grid.tiles} are
 * treated as local offsets from that origin.
 */
public final class GridFinder {
  ...
  public static Tile findTileUnder(Entity entity, Grid grid) {
    ...
    return TileFinder.findTileAt(
        toLocalTileCoordinate(entity.getPosition(), grid), grid.getTilesMap());
  }
