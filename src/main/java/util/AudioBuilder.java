...
public final class AudioBuilder {
  ...
  public static Audio createLoopingSoundEffectAtEntity(
      String name, int entityId, int map, float volume) {
  ...
  public static Audio createLoopingAmbientSound(
      String name, Vector position, int map, float volume) {
