...
public final class OrganEnergy {
  ...
  public static CardiovascularSystem withNutrition(
      CardiovascularSystem cardiovascularSystem, float nutrition, float maximumNutrition) {
  ...
  public static CardiovascularSystem addNutrition(
      CardiovascularSystem cardiovascularSystem, float nutrition) {
    ...
    float maximumNutrition =
        cardiovascularSystem.hasMaxNutrition()
            ? positive(cardiovascularSystem.getMaxNutrition())
            : currentNutrition + addedNutrition;
    return withNutrition(cardiovascularSystem, currentNutrition + addedNutrition, maximumNutrition);
  }
